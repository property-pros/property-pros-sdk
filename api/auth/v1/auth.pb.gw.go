...
func RegisterAuthenticationServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server AuthenticationServiceServer) error {
	...
	mux.Handle("POST", pattern_AuthenticationService_AuthenticateUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/api.auth.v1.AuthenticationService/AuthenticateUser", runtime.WithHTTPPathPattern("/v1/authenticate-user"))
		if err != nil {
...
func RegisterAuthenticationServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AuthenticationServiceClient) error {
	...
	mux.Handle("POST", pattern_AuthenticationService_AuthenticateUser_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/api.auth.v1.AuthenticationService/AuthenticateUser", runtime.WithHTTPPathPattern("/v1/authenticate-user"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
